                    ...
                    {(progress) => (
                        ...
                        >
                            ...
                            <div className={`${css.g2}`}>
                                <h1>SKILLS</h1>
                                <p>
                                    FullStack developer con mayor inclinación y
                                    pasión en el frontend, maestro javascript,
                                    desarrollador de soluciones y vehemente por
                                    profundizar nuevas herramientas y
                                    conocimientos.
                                </p>
                            </div>
                        </div>
